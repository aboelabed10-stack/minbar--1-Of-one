...
.signup{
margin-top:9px;
background:linear-gradient(135deg,#16846d,#087db5);
}
...
<button class="close"
onclick="closeStudentLogin()">×</button>
...
message.innerText =
"⚠️ أدخل البريد الإلكتروني وكلمة المرور.";
...
message.innerText =
"⚠️ أدخل البريد وكلمة المرور أولًا.";
